...
const userNavItems = [
  ...
  { route: 'cron', label: '定时任务', icon: '<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6"/><path d="M8 4.5V8l2.5 1.5"/><path d="M3.5 2.5 2 4M12.5 2.5 14 4"/></svg>' },
